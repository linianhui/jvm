...
class UTF8ConstantTest extends AbstractTest {
    ...
    void test_ConstantUtf8() {
        Bytes bytes = newBytes(0x00, 0x06, 0x3C, 0x69, 0x6E, 0x69, 0x74, 0x3E);
        UTF8Constant constant = new UTF8Constant(null, bytes);
    ...
    void test_fromModifiedUtf8() {
        ...
        String value = UTF8Constant.fromModifiedUtf8(bytes);

        Assertions.assertEquals(21, bytes.getLength());
    ...
    void test_fromModifiedUtf8_emoji() {
        ...
        Assertions.assertEquals(15, bytes.getLength());
