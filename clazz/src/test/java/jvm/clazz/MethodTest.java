...
class MethodTest extends AbstractTest {
    ...
    void test_Method() {
        ...
        Methods methods = Methods.from(null, bytes, 2);

        Assertions.assertEquals(2, methods.getCount());

        Assertions.assertEquals(1, methods.get(0).getAccessFlags().size());
        Assertions.assertTrue(methods.get(0).getAccessFlags().contains(Method.AccessFlag.Public));
        ...
        Assertions.assertTrue(methods.get(1).getAccessFlags().contains(Method.AccessFlag.Public));
        Assertions.assertTrue(methods.get(1).getAccessFlags().contains(Method.AccessFlag.Static));
